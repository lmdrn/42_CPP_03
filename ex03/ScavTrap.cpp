...
/*   Updated: 2024/04/19 18:31:39 by lmedrano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap ()
: ClapTrap("defaultScav"), _hitPoints(100), _energyPoints(50), _attackDamage(20)
{
...
: ClapTrap(_name), ClapTrap(_hitPoints(100)), ClapTrap(_energyPoints(50)), ClapTrap(_attackDamage(20))
{
...
{
	std::cout << "ScavTrap " << "\x1b[32m" << copy._name << "\x1b[0m" << " copy constructor has been called!" << std::endl;
}
//destructeur
